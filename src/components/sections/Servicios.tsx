        ...
        <div className="mx-auto flex w-full lg:max-w-[var(--band)] flex-1 flex-col px-6 pb-[clamp(124px,calc(var(--band)*0.1117647059),263.2px)] pt-[clamp(88px,calc(var(--band)*0.08),187.68px)] lg:px-[clamp(60px,calc(var(--band)*0.0541176471),127px)]">
          ...
          <div className="flex flex-col">
            ...
            <motion.p
              ...
              className="mt-[clamp(62px,calc(var(--band)*0.0558823529),131.1px)] w-full max-w-none text-16 font-regular text-alto sm:max-w-[clamp(282px,calc(var(--band)*0.2535294118),594.8px)] sm:text-[clamp(9px,calc(var(--band)*0.0105882353),18px)]"
            >
