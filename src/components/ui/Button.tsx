...
const buttonSmallClass =
  'inline-flex items-center justify-center rounded-2 bg-cloud px-[clamp(5px,calc(var(--band)*0.0047058824),11.04px)] py-[clamp(5px,calc(var(--band)*0.0047058824),11.04px)] font-bold text-[clamp(6px,calc(var(--band)*0.0052941176),12.42px)] uppercase tracking-[clamp(0.6px,calc(var(--band)*0.0005294118),1.242px)] text-ebony shadow-button focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cloud'
